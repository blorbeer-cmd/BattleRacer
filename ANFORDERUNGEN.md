...
| **A-013** | 🔴 | 🔄 | **Drift + Mini-Turbo:** Drift-Knopf mit Hop, gehaltener Drift lädt Funken-Stufen (2 Stufen wie MK64), Boost beim Lösen; Drift-Richtung unabhängig von Lenk-Feineinstellung — Hop-Impuls (`drift_hop_impulse`) und provisorische Farb-Rückmeldung je Mini-Turbo-Stufe (Platzhalter bis zu echten Funken-VFX in A-063) ergänzt. **Von echtem Gamepad-Spieler bisher als „merkwürdig" und schwer beurteilbar eingestuft** — Timing/Balance braucht weitere Spielrunden |
